...
#### PA0 - Setup and Environment Testing
Link GitHub Classroom account, clone repository, and test devcontainer with PLCC

**Key Topics**:
- Working devcontainer environment with PLCC
- Successfully run PLCC and evaluate a simple grammar
- Basic understanding of PLCC workflow
- Provided background information to help tailor the course


*This assignment verifies your development environment works before we dive into complex language implementation projects.*


#### PA1 - Lexical Specification
Write lexical specifications for PLCC, implement tokenization

**Key Topics**:
- Skip patterns (whitespace, comments)
- Token definitions
- Regular expressions in PLCC
- Lexical error handling



#### PA2 - Grammar and Parsing
Define grammars and build parsers using PLCC
...
#### PA4 - LetExp Language
Implement let-expressions and variable binding
...
#### PA5 - Procedures and Functions
Add procedures with parameters to the language
...
#### PA7 - Object-Oriented Features
Add classes and inheritance to the language
...
#### PA8 - Class Implementation
Complete OOP implementation with polymorphism
...
#### PA9 - Infix Calculator
Build an infix expression evaluator with precedence
...
#### PAA - Logic Programming
Implement basic Prolog-like features
...
#### PAB - Continuations and Control
Implement continuations or exception handling
